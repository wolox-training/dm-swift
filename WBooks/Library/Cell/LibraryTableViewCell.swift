...
class LibraryTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var titleLabel: UILabel!{
        didSet{
            titleLabel.font = UIFont(name: "Gill Sans", size: 16)
            titleLabel.textColor = UIColor.darkGray
        }
    }
    @IBOutlet weak var autorLabel: UILabel!{
        didSet{
            autorLabel.font = UIFont(name: "Gill Sans", size: 14)
            autorLabel.textColor = UIColor.lightGray
        }
    }
    
    let identifier = "LibraryTableViewCell"
    let nibName = "LibraryTableViewCell"
    
    var data: Book!
    
    override func awakeFromNib() {
        super.awakeFromNib()
        contentView.backgroundColor = UIColor.init(red: 236, green: 246, blue: 249, alpha: 1)
    }
